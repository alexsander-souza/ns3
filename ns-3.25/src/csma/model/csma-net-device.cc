...
void CsmaNetDevice::SetDataRate(DataRate &rate)
{
  m_bps = rate;
...
void CsmaNetDevice::SetLineProtocolStatus(bool established)
{
  NS_LOG_FUNCTION (this << established);
  m_linkUp = established;
  m_linkChangeCallbacks ();
}
